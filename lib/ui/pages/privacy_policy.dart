          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: bodyTextStyle.copyWith(fontSize: 16, color: context.colors.textPrimary),
              ),
              const SizedBox(height: 16),
              Text(
                '1. Information We Collect',
                style: h3Style.copyWith(fontSize: 20, color: context.colors.textPrimary),
              ),
              const SizedBox(height: 8),
              Text(
                'a. Personal Information',
                style: h3Style.copyWith(fontSize: 18, fontWeight: FontWeight.w600, color: context.colors.textPrimary),
              ),
              Text(
